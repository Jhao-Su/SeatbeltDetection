...
# # # -*- coding: utf-8 -*-
# # """
# # 安全带检测模型评测脚本（RTDETR 版本）
# # 使用 seatbelt_det.pt 权重进行推理
# # P/R/F1 曲线横坐标为置信度分数（而非阈值）
# # 展示不同置信度水平下的模型性能
# # """
...
# # # ==================== 配置路径 ====================
# # MODEL_PATH = "/home/ubuntu/graduation_design/seatbelt_det.pt"
# # TEST_IMAGES_DIR = "/home/ubuntu/graduation_design/valid/images"
# # TEST_LABELS_DIR = "/home/ubuntu/graduation_design/valid/labels"
# # OUTPUT_DIR = "/home/ubuntu/graduation_design/test_result"
...
# # def rtetr_detect_single_frame(model, image):
# #     """
# #     使用 RTDETR 模型进行单帧检测
# #     返回格式与 seatbelt_detector.py 一致：
# #     {
# #         'frame': 绘制了检测框的图片,
# #         'results': [{'cls': int, 'bbox': [x1,y1,x2,y2], 'conf': float}, ...]
# #     }
# #     """
# #     # RTDETR 推理
...
# #                 color = (0, 0, 255) if cls_id == 0 else (0, 255, 0)  # 绿色=未系，红色=系
...
# #     # 加载 RTDETR 模型
# #     print(f"加载 RTDETR 模型：{MODEL_PATH}")
...
# #         # 使用 RTDETR 模型进行检测
# #         result = rtetr_detect_single_frame(model, image)
...
TEST_IMAGES_DIR = "/home/ubuntu/graduation_design/test/images"
TEST_LABELS_DIR = "/home/ubuntu/graduation_design/test/labels"
OUTPUT_DIR = "/home/ubuntu/graduation_design/test_result_v1"
IMAGES_DIR = os.path.join(OUTPUT_DIR, 'images')
INFOS_DIR = os.path.join(OUTPUT_DIR, 'infos')
IOU_THRESHOLD = 0.5
# ==================== 类别配置（与 seatbelt_detector.py 一致） ====================
...
def evaluate():
    ...
    all_predictions, all_ground_truth, inference_times = [], [], []
